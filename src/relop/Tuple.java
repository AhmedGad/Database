...
public class Tuple {
	 ...
	 * 
	 * @param schema
	 *            logical information for the fields
	 */
	 ...
	 *            logical information for the fields
	 * @param values
	 *            individual data values of the fields
	 */
	 ...
	 *            logical information for the fields
	 * @param data
	 *            record buffer containing the tuple
	 */
	...
	public String getStringFld(int fldno) {
		return Convert.getStringValue(schema.fieldOffset(fldno), data,
				schema.fieldLength(fldno));
	}
	 ...
	 * 
	 * @param fieldLen
	 *            minimum length of the current field
	 * @param outputLen
