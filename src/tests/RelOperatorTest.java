   ...
   */
	...
	protected boolean test3() {
		try {
			...
			saveCounts(null);
			// HashJoin join1 = new HashJoin(new FileScan(s_groups, groups), new
			// FileScan(s_rides, rides), 0, 1);
			// HashJoin join2 = new HashJoin(join1, new FileScan(s_drivers,
			// drivers), 2, 0);
			// Selection sel = new Selection(join2, new
			// Predicate(AttrOperator.LT,
